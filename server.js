...
log('Using SSL:', process.env.DEPLOYMENT_ENVIRONMENT === 'production');
if (process.env.DEPLOYMENT_ENVIRONMENT == "production") {
  // const ca = fs.readFileSync(path.join(__dirname, 'certs', 'DigiCertGlobalRootG2.pem'));
  // console.log('[DEBUG] CA Loaded:', ca.toString().substring(0, 80));
